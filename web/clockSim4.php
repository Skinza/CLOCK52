...
<html>
	<head>
		<title>Clock 52 Sim test 4</title>
	...
	<body onload="startClock52()">
		...
		<?php
			...
			Dag: <input type="text" disabled="disabled" id="dagTxt" /><input type="button" value="+" disabled="disabled" id="dagPlus" onClick="dagPlus()" /><input type="button" value="-" disabled="disabled" id="dagMin" onClick="dagMin()" /><br />
			...
			<script type="text/javascript">
				...
				function dagPlus() {
                                        var elem = document.getElementById('dagTxt');
                                        var val = parseInt(elem.value)+1;
                                        if(val > 31) { val = 1; }
                                        elem.value = val;
                                        updateClock52();
				...
				function toggleManual() {
					if(isManual) {
						...
						document.getElementById('dagPlus').disabled="disabled";
						document.getElementById('dagMin').disabled="disabled";
					} else {
						...
						document.getElementById('uurPlus').disabled="";
                                                ...
                                                document.getElementById('dagPlus').disabled="";
                                                document.getElementById('dagMin').disabled="";
				...
				function updateClock52() {
					...
					if(!isManual) {// vraag datum op
						...
						document.getElementById('dagTxt').value=d;
						...
						var d = parseInt(document.getElementById('dagTxt').value);
						var s = 0;
					}
					...
					else if(m < 10) { setMinuutVijf(255,255,255); setOver2(255,255,255); }
				...
				function setDatum(dag) {
					dagTiental = Math.floor(dag/10);
					dagEnkel = dag%10;

					switch(dagTiental) {
						case 0: break; // do nothing
						case 1: setPixel(105,0,255,0); break;
						case 2: setPixel(106,0,255,0); break;
						case 3: setPixel(110,0,255,0); break;
					}
					
					switch(dagEnkel) {
						case 0: setPixel(120,255,255,255); break;
						case 9: setPixel(119,255,255,255); break;
						case 8: setPixel(118,255,255,255); break;
						case 7: setPixel(117,255,255,255); break;
						case 6: setPixel(116,255,255,255); break;
						case 5: setPixel(115,255,255,255); break;
						case 4: setPixel(114,255,255,255); break;
						case 3: setPixel(113,255,255,255); break;
						case 2: setPixel(112,255,255,255); break;
						case 1: setPixel(111,255,255,255); break;
					}
				}
